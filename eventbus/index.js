...
app.post('/events', async(req, res) => {
    ...
    axios.post('http://hsposts:4000/events', event).catch((err) => {
      console.log(err.message); //this is the post service
    });
    axios.post('http://hscomments:4001/events', event).catch((err) => {
      console.log(err.message); //this is the comment service
    });
    axios.post('http://hsquery:4002/events', event).catch((err) => {
      console.log(err.message); //this is the query service
    });
    axios.post('http://hsmoderation:4003/events', event).catch((err) => {
